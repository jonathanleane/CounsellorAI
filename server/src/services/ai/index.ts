...
export class AIService {
  ...
  getAvailableModels(): Array<{ model: AIModel; name: string; provider: AIProvider; available: boolean }> {
    return [
      { model: AIModel.GPT4_Turbo, name: 'GPT-4 Turbo', provider: AIProvider.OpenAI, available: true },
      { model: AIModel.GPT4, name: 'GPT-4', provider: AIProvider.OpenAI, available: true },
      { model: AIModel.O3, name: 'O3 (Coming Soon)', provider: AIProvider.OpenAI, available: false },
      { model: AIModel.Claude3_Opus, name: 'Claude 3 Opus', provider: AIProvider.Anthropic, available: true },
      { model: AIModel.Claude3_Sonnet, name: 'Claude 3 Sonnet', provider: AIProvider.Anthropic, available: true },
      { model: AIModel.Claude4_Opus, name: 'Claude 4 Opus (Coming Soon)', provider: AIProvider.Anthropic, available: false },
      { model: AIModel.Gemini_Pro, name: 'Gemini Pro', provider: AIProvider.Google, available: true },
